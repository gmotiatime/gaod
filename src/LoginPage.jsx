      ...
      <div className="w-full max-w-md flex flex-col items-center">
        ...
        <div className="mb-8">
          <svg
            viewBox="0 0 100 100"
            fill="currentColor"
            className="w-16 h-16 text-[#1A1A1A]"
          >
        ...
        {/* Text */}
        <h1 className="text-3xl md:text-4xl font-serif text-[#1A1A1A] mb-3 text-center tracking-tight">
          Welcome to Gaod
        </h1>
        <p className="text-gray-500 mb-10 text-center text-sm tracking-wide">
          Sign in to access your Gaod space
        </p>
