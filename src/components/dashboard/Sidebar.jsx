        ...
        <aside className={cn(
          ...
          <div className="p-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
                ...
                <span className="font-serif text-xl font-bold tracking-tight text-[#1A1A1A]">Gaod</span>
            </div>
            <button onClick={onClose} className="md:hidden p-2 text-gray-500 hover:text-[#1A1A1A] transition-colors rounded-lg hover:bg-gray-200/50">
                <X className="w-6 h-6" />
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto px-3 space-y-1 scrollbar-hide">
            ...
            <AnimatePresence initial={false}>
                ...
                >
                    ...
                    >
                        <MessageSquare className={cn("w-4 h-4 flex-shrink-0 transition-colors", activeChatId === chat.id ? "text-[#1A1A1A]" : "text-gray-400 group-hover:text-gray-600")} />
                        <span className={cn("text-sm truncate font-medium transition-colors", activeChatId === chat.id ? "text-[#1A1A1A]" : "text-gray-600 group-hover:text-[#1A1A1A]")}>
                        {chat.title}
                        </span>
                    </button>
