...
const faqs = [
  {
    ...
    answer:
      'The Gaod Early Access Program allows a select group of users to experience our domain-specific AI tools before the public launch. Participants get exclusive access to new features and direct channels to provide feedback.',
  },
  {
    question: 'How can I join the Early Access Program?',
    answer:
      "You can request access by clicking the 'Request early access' button in the navigation bar. We review applications on a rolling basis and prioritize teams and agencies with immediate use cases.",
  },
  {
    question: 'How do I get in touch?',
    answer:
      'For support inquiries, please email support@gaod.ai. For enterprise sales or partnership opportunities, contact sales@gaod.ai.',
  },
];
