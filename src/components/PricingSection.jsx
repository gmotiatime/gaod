    ...
    <section className="w-full max-w-6xl mx-auto px-4 py-24">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
        ...
        <div className="flex items-center gap-4">
            <span className="text-xs font-mono tracking-widest text-gray-500 uppercase">Billing Cycle</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-3xl p-8 border border-gray-100 flex flex-col hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="mt-auto">
                ...
                <ul className="space-y-3 text-sm text-gray-600">
                    ...
                    <li className="flex items-start gap-2">
                        <span className="border-b border-gray-300 border-dashed pb-0.5">One project</span> to analyze customer calls, recordings, docs, and surveys
                    </li>
                    <li className="flex items-start gap-2">
                         Chat with and summarize your data to uncover trends and run analysis
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div className="bg-[#1A1A1A] text-white rounded-3xl p-8 border border-gray-900 flex flex-col shadow-xl relative overflow-hidden">
            <div className="mb-8 relative z-10">
                <div className="flex justify-between items-start mb-6">
                     ...
                     <span className="bg-blue-600 text-white text-[10px] font-bold px-2 py-1 rounded">SAVE 25%</span>
                </div>
            ...
            <div className="mb-8 relative z-10">
                <div className="flex items-baseline gap-2">
                    <span className="text-5xl font-serif">${billingCycle === 'yearly' ? '12' : '15'}</span>
            ...
            <div className="mt-auto relative z-10">
                <p className="text-xs font-mono uppercase text-gray-500 mb-4 tracking-wider">Everything in Free, plus</p>
                <ul className="space-y-3 text-sm text-gray-300">
                    <li className="flex items-start gap-2">
                        <span className="border-b border-gray-600 border-dashed pb-0.5">Unlimited channels</span> (paid add-on) to automatically classify your voice of customer data
                    </li>
                    <li className="flex items-start gap-2">
                        <span className="border-b border-gray-600 border-dashed pb-0.5">Unlimited projects</span> to analyze customer calls, layouts, views, filters
                    </li>
                    <li className="flex items-start gap-2">
        ...
        <div className="bg-white rounded-3xl p-8 border border-gray-100 flex flex-col hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="mt-auto">
                <p className="text-xs font-mono uppercase text-gray-400 mb-4 tracking-wider">Everything in Professional, plus</p>
                <ul className="space-y-3 text-sm text-gray-600">
                    <li className="flex items-start gap-2">
                        Unlimited free viewers and <span className="border-b border-gray-300 border-dashed pb-0.5">unlimited AI chat</span> in Slack and Teams
                    </li>
                    <li className="flex items-start gap-2">
                        Organization features like folders, global tags, fields, templates
                    </li>
                    <li className="flex items-start gap-2">
                         Advanced AI features including <span className="border-b border-gray-300 border-dashed pb-0.5">custom vocabulary</span> and translation
                    </li>
                     <li className="flex items-start gap-2">
                         Secure with redaction, compliance, access control, and data retention
                    </li>
                     <li className="flex items-start gap-2">
                         Priority support, dedicated customer success, onboarding assistance
                    </li>
                </ul>
            </div>
        </div>
