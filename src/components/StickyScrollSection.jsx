...
const content = [
  {
    ...
    description:
      'Centralize all your creative assets in one searchable library. Connect your tools to auto-import references, moodboards, and design systems.',
  ...
  },
  {
    ...
    description:
      'Turn visual data into direction. Spot patterns in your inspiration and quantify what works so you can prioritize the concepts that actually matter.',
  ...
  },
  {
    ...
    description:
      'Move from idea to execution instantly. Chat with your library and generate briefs, copy, and prototypes giving AI the context to ship fast.',
  ...
  },
  {
    ...
    description:
      'Cut weeks of manual work into hours. Automate everything from asset resizing to format adaptation, allowing you to ship more without adding headcount.',
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const targetIndex = Math.floor(
        (-top + viewportHeight / 2) / viewportHeight
      );
