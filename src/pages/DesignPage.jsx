    ...
    <div className="min-h-screen w-full flex flex-col items-center bg-[#F8F8F6] text-[#1A1A1A] font-sans relative">
      ...
      <main className="flex-grow w-full max-w-6xl px-4 mt-32 mb-20 z-10 flex flex-col items-start">
        ...
        <div className="mb-32 w-full">
          ...
          <div className="mb-16">
            <MoleculeIcon
              className="w-16 h-16 text-[#1A1A1A] mb-8"
              mode="static"
            />
            ...
            <p className="text-2xl text-gray-400 mt-8 max-w-2xl leading-relaxed">
              ...
              We believe in tools that disappear, leaving only the creator and
              their work.
            </p>
          </div>
        </div>
        ...
        <div className="w-full mb-32">
          ...
          {/* Colors */}
          <div className="mb-20">
            <h3 className="text-sm font-mono uppercase text-gray-500 mb-8 tracking-wider">
              Colors
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-4">
                <div className="border-b border-gray-200 pb-2 mb-4">
                  <span className="font-mono text-xs text-gray-400">
                    Headings / Serif / Times New Roman
                  </span>
                </div>
              ...
              <div className="space-y-4">
                ...
                <p className="font-sans text-lg leading-relaxed text-gray-600">
                  The quick brown fox jumps over the lazy dog. Designed for
                  legibility and clarity in user interfaces. Scale your output
                  with tools that understand your context.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-20">
            ...
            <div className="p-8 bg-white rounded-2xl border border-gray-200 flex items-center justify-around gap-8">
              <div className="flex flex-col items-center gap-4">
                <MoleculeIcon
                  className="w-24 h-24 text-[#1A1A1A]"
                  mode="static"
                />
