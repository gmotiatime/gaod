      ...
      <main className="flex-grow w-full max-w-6xl px-4 mt-32 z-10 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center justify-center min-h-[85vh] text-center mb-20">
          ...
          <p className="text-2xl md:text-3xl text-[#9CA3AF] max-w-2xl leading-tight tracking-tight">
            Gaod is the domain-specific AI for next-gen creators, agencies, and the Fortune 500.
          </p>
        </div>
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6 mb-32 px-4">
            ...
            >
                ...
                <div className="mt-6">
                    <div className="flex items-center gap-2 mb-2">
                         ...
                         <h3 className="text-[#1A1A1A] font-medium text-lg">Friendly UI</h3>
                    </div>
            ...
            >
                 ...
                 <div className="mt-6">
                    <div className="flex items-center gap-2 mb-2">
                         <div className="w-2 h-2 rounded-full bg-[#1A1A1A]" />
                         <h3 className="text-[#1A1A1A] font-medium text-lg">Chat Management</h3>
                    </div>
                    <p className="text-gray-500 text-sm leading-relaxed">
            ...
            >
                ...
                <div className="mt-6">
                    <div className="flex items-center gap-2 mb-2">
                         <div className="w-2 h-2 rounded-full bg-[#1A1A1A]" />
                         <h3 className="text-[#1A1A1A] font-medium text-lg">Maximum Control</h3>
                    </div>
                    <p className="text-gray-500 text-sm leading-relaxed">
        ...
        <div className="w-full mb-32 px-4">
            <div className="mb-16">
                <span className="text-gray-500 font-mono text-sm tracking-widest uppercase mb-4 block">Enterprise</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div className="flex flex-col items-start gap-6">
                    ...
                    <div>
                        <h3 className="text-xl font-medium text-[#1A1A1A] mb-3">Brand Guidelines</h3>
                        <p className="text-gray-500 text-sm leading-relaxed">
                ...
                <div className="flex flex-col items-start gap-6">
                    ...
                    <div>
                        <h3 className="text-xl font-medium text-[#1A1A1A] mb-3">Web Design</h3>
                        <p className="text-gray-500 text-sm leading-relaxed">
                ...
                <div className="flex flex-col items-start gap-6">
                    ...
                    <div>
                        <h3 className="text-xl font-medium text-[#1A1A1A] mb-3">Framer Development</h3>
                        <p className="text-gray-500 text-sm leading-relaxed">
                            Fully Responsive Website Development, done using a no code tool, Framer.
                        </p>
                    </div>
                </div>
